        ...
        <form className='formulario-login-Register' onSubmit={(e) => onHandledSubmit(e)}>
          <div className="form-row pt-2 centrarFilaFormulario p-2">
            <div className="col-12 col-sm-8 ">
              ...
              <input type="text" name='displayName' className={`form-control ${displayNameValid ? 'is-invalid' : ''} `} id='txtName' placeholder='Name' required
                value={displayName}
          ...
          <div className="form-row pt-2  centrarFilaFormulario p-2 ">
            <div className="col-12 col-sm-8">
              ...
              <input type="email" className={`form-control ${emailValid ? 'is-invalid' : ''} `} name='email' id='txtEmail' placeholder='Email' required
                value={email}
                onChange={(e) => { onInputChange(e) }}
              />
            </div>
          ...
          <div className="form-row pt-2  centrarFilaFormulario p-2">
            <div className="col-12 col-sm-8">
              ...
              <input type="password" className={`form-control ${password1Valid ? 'is-invalid' : 'is-valid'} `} name='password1' id='txtPassword1' placeholder='Password' required
                value={password1}
                onChange={(e) => { onInputChange(e) }}
              />
            </div>
          ...
          <div className="form-row pt-2  centrarFilaFormulario p-2">
            <div className="col-12 col-sm-8">
              ...
              <input type="password" className={`form-control ${(password2Valid) ? 'is-invalid' : ''} `} name='password2' id='txtPassword2' placeholder='Password' required
                value={password2}
                onChange={(e) => { onInputChange(e) }}
              />
            </div>
