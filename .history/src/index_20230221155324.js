...
const App2=()=>{
    ...
    const {Nombre,Email,onChangeValor,NombreValid,formValid} = useFormularioDany(initialForm,validaciones)
    return(
        <>
        <h1>App2</h1>
        <form action="">
        ...
        <button onClick={()=>{console.log({Nombre,Email,NombreValid,formValid})}}>dsfsdf</button>
        </>
    )
}
