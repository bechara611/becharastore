    ...
    return (
        <>
            ...
            <div className="col-12 PadreHome">
                ...
                <div className="col-12 col-md-6 m-1 contenedor-escrito ">
                    ...
                    <div className="col-12 contenedor-texto ">
                        ...
                        <div className="col-12"><button type='button' className='btn btn-success col-6 btn-texto '><NavLink className='nav-item nav-link'>Products</NavLink> </button></div>
            ...
            <div className="col-12 mb-5 contenedor-contacto">
                ...
                <div className="contenedor-contacto col-12 p-3">
