...
const [estadoAnimacion, setestadoAnimacion] = useState({
    ...
    useEffect(() => {
        ...
        if (estadoAnimacion.contacto===true) {
            ...
            document.getElementById('contenedor-contacto').classList.add('visibility0')
            setTimeout(() => {
                
                document.getElementById('contenedor-contacto').classList.remove('visibility0')
    ...
    return (
        <>
            ...
            <div className="col-12 mb-5 contenedor-contacto animate__animated animate__lightSpeedInLeft  " id='contenedor-contacto-padre'>
                ...
                <div className="contenedor-contacto col-12 p-3 visibility0   " id='contenedor-contacto'>
