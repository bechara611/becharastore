    ...
    useEffect(() => {
        ...
        if (estadoAnimacion.contacto===true) {
            ...
            setTimeout(() => {
                ...
                document.getElementById('contenedor-contacto').classList.add('animate__animated animate__lightSpeedInLeft')
    ...
    return (
        <>
            ...
            <div className="col-12 mb-5 contenedor-contacto  " id='contenedor-contacto-padre'>
                ...
                <div className="contenedor-contacto col-12 p-3 animate__animated animate__lightSpeedInLeft  " id='contenedor-contacto'>
