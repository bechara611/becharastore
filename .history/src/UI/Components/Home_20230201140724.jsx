    ...
    useEffect(() => {
        ...
        if (estadoAnimacion.contacto===true) {
            ...
            setTimeout(() => {
                ...
                document.getElementById('contenedor-contacto').classList.remove('animate__animated')
                document.getElementById('contenedor-contacto').classList.remove('animate__lightSpeedInLeft')
                document.getElementById('contenedor-contacto').classList.add('animate__animated')
                document.getElementById('contenedor-contacto').classList.add('animate__lightSpeedInLeft')
            }, 100);
        }
