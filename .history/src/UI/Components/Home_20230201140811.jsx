...
const [estadoAnimacion, setestadoAnimacion] = useState({
    ...
    useEffect(() => {
        ...
        if (estadoAnimacion.contacto===true) {
            ...
            setTimeout(() => {
                document.getElementById('contenedor-contacto-padre').classList.remove('visibility0')
                document.getElementById('contenedor-contacto-padre').classList.remove('animate__animated')
                document.getElementById('contenedor-contacto-padre').classList.remove('animate__lightSpeedInLeft')
                document.getElementById('contenedor-contacto-padre').classList.add('animate__animated')
                document.getElementById('contenedor-contacto-padre').classList.add('animate__lightSpeedInLeft')
            }, 1000);
        }
    ...
    return (
        <>
            ...
            <div className="col-12 mb-5 contenedor-contacto animate__animated animate__lightSpeedInLeft visibility0  " id='contenedor-contacto-padre'>
