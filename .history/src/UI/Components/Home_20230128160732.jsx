...
useEffect(() => {
  console.log(window.screen.width.toPrecision())
            ...
            <div className="col-12 PadreHome">
                ...
                <div className="col-12 col-md-6 m-1 contenedor-escrito ">
                    ...
                    <div className="col-12 contenedor-texto ">
                        ...
                        <div className="col-12"><button type='button' id='BotonRegistro' className='btn btn-outline-warning mt-3 col-6'>Create a new account</button></div>
                    </div>
