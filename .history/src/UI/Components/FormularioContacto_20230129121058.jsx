                    ...
                    <div className="row col-12 col-sm-10 m-2">
                        <div className="col-12 m-2">
                            <div className="form-group ">
                                ...
                                <input value={formValuesContact.email} type="email" className='form-control' id='exampleInputEmail1' aria-describedby='emailHelp' placeholder='Email' />
                    ...
                    <div className="row col-12 col-sm-10 m-2">
                        <div className="col-12 m-2">
                            <div className="form-group ">
                                ...
                                <input value={formValuesContact.name} type="text" className='form-control' id='inputname' aria-describedby='emailHelp' placeholder='Name' />
                   ...
                   <div className="row col-12 col-sm-10 m-2">
                        <div className="col-12 m-2">
                            <div className="form-group ">
                                ...
                                <textarea value={formValuesContact.message} className='form-control textarea' id='inputname' aria-describedby='emailHelp' placeholder='Message' />
