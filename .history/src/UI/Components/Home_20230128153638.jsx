    ...
    return (
        ...
        {/*De primera instancia en este home estamos haciendo dos separadores de div, que tendran con un eslogan y algun dise;o de home*/}
            <div className="col-12 PadreHome">
                ...
                <div className="col-12"><button type='button' className='btn btn-success col-6'>Login</button></div>
                <div className="col-12"><button type='button' className='btn btn-warning mt-3 col-6'>Register</button></div>
                </div>
