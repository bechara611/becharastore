                    ...
                    <div className="row col-10 m-2">
                        ...
                        <div className="col-12">
                            <div className="form-group ">
                                ...
                                <input type="text" className='form-control' id='inputname' aria-describedby='emailHelp' placeholder='Email' />

                                <small id="nameHelp" className="form-text text-muted">Please insert your email</small>
                            </div>
                        </div>
                    </div>
