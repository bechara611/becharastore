...
const [estadoAnimacion, setestadoAnimacion] = useState({
    ...
    return (
        <>
         ...
         <div className="col-12 contenedor-articulos-home contenedor-contacto">
            <div className="col- contenedor-contacto">
                <h4 className='titulo-contacto  animate__animated animate__lightSpeedInLeft  '>All of our products are waiting for you!</h4>
            </div>
        </div>
