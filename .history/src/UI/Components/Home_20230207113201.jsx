...
const [estadoAnimacion, setestadoAnimacion] = useState({
    ...
    useEffect(() => {
        ...
        if (estadoAnimacion.productosHome===true) {
            ...
            setTimeout(() => {
                ...
                document.getElementById('11').classList.add('animate__animated')
                document.getElementById('11').classList.add('animate__fadeInLeftBig')
                document.getElementById('11').classList.remove('opacity0')
            }, 200);
        }
    ...
    return (
        ...
        <div className="col-12 contenedor-producto-home-jr" id='contenedor-producto-home-jr'>
        ...
        <p className='SeeMore mb-5' onClick={()=>{navegar('/products',{replace:true})}}>View all</p>
        </div>
        </div>
