                ...
                <nav className="navbar navbar-expand-md  menunav col-8 ">
                    ...
                    <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div className="navbar-nav col-12  contenedor-interno-nav">
                            ...
                            <NavLink className={ ({isActive}) => `nav-item nav-link  ${ isActive ? 'active':'' }` } to={'/re'}>Register</NavLink>
                            <NavLink className={ ({isActive}) => `nav-item nav-link  ${ isActive ? 'active':'' }` } to={'/pro'}>Products</NavLink>
                        </div>
                    </div>
                </nav>
            </div>
