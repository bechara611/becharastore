...
export const FormularioContacto = () => {
    return (
        <>
            <div className=" m-3 p-3 col-12 col-sm-10 col-md-8 col-lg-5 contenedor-formulario-contacto  animate__animated animate__bounceInLeft">
                <form className='formularioContacto'>
                    ...
                    <div className="form-group ">
                        ...
                        <textarea className='form-control textarea' id='inputname' aria-describedby='emailHelp' placeholder='Name' />
