...
const [estadoAnimacion, setestadoAnimacion] = useState({
    ...
    useEffect(() => {
        ...
        if (estadoAnimacion.contacto===true) {
            ...
            setTimeout(() => {
                ...
                document.getElementById('contenedor-contacto-padre').classList.remove('opacity0')
    ...
    return (
        <>
            ...
            <div className="col-12 mb-5 contenedor-contacto opacity0 " id='contenedor-contacto-padre'>
                ...
                <div className="contenedor-contacto col-12 p-3  animate__animated animate__fadeInLeftBig" id='contenedor-contacto'>
