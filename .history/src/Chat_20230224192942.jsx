        ...
        <div className="card">
          <div className="card-body">
            ...
            <ul className="list-unstyled mb-0">
              <li className="p-2 border-bottom" style="background-color: #eee;">
      ...
      <div className="col-md-6 col-lg-7 col-xl-8">
        ...
        <ul className="list-unstyled">
          <li className="d-flex justify-content-between mb-4">
            <img src="https://mdbcdn.b-cdn.net/img/Photos/Avatars/avatar-6.webp" alt="avatar"
              className="rounded-circle d-flex align-self-start me-3 shadow-1-strong" width="60"></img>
            <div className="card">
          ...
          <li className="d-flex justify-content-between mb-4">
            ...
            <img src="https://mdbcdn.b-cdn.net/img/Photos/Avatars/avatar-5.webp" alt="avatar"
              className="rounded-circle d-flex align-self-start ms-3 shadow-1-strong" width="60"></img>
          </li>
          <li className="d-flex justify-content-between mb-4">
            <img src="https://mdbcdn.b-cdn.net/img/Photos/Avatars/avatar-6.webp" alt="avatar"
              className="rounded-circle d-flex align-self-start me-3 shadow-1-strong" width="60"></img>
