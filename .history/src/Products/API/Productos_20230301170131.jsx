...
export const DeleteProductos = async ({productoBD}) => {


    return new Promise(async(resolve, reject) => {
        try {
   //console.log({productoBD})
            const {data} = await InstanceBD.delete(`products/delete/${productoBD._id}`)
    ...
    return new Promise(async(resolve, reject) => {
        try {
            let objeto = {
                ...
                categoria:productoNuevo.productocategoria,
