...
export const DeleteProducto = async () => {
    //TODO este como tal es el metodo borrar producto, debes recibir el id o los datos completos del producto
...
export const UpdateProductos = async () => {
    //TODO este como tal es el metodo borrar categoria, debes recibir el id o los datos completos del producto
