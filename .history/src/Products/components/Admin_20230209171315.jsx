...
export const Admin = () => {
    ...
    useEffect(() => {
        ...
        setform({ ...form, categorySeleccionada:categorias[0]==="ALL" ? categorias[1] : 'MEEEEN'})
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [categorias])
    ...
    const onDeleteCategorias = () => {
        ...
        if(form.categorySeleccionada===''){
            ...
            if(form.categorySeleccionada==='' || form.categorySeleccionada===undefined || form.categorySeleccionada===null){
                setform({ ...form, categorySeleccionada:(categorias[0] === 'ALL' ?  categorias[1] : categorias[0])})
                console.log('hola')
            }
