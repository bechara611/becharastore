    ...
    return (
        <>
            ...
            <div className="row fila ">
                <div className="col-lg-4 col-12 contenedorGeneral contenedor-categorias animate__animated animate__zoomInLeft">
                ...
                <div className="col-12 col-md-4 contenedorGeneral contenedor-productos animate__animated animate__zoomInRight">
