...
export const ListadoProductos = () => {
    ...
    useEffect(() => {
        ...
        setbotones({...botones,botonReset:false,botonSearch:false, botonCategoria:false})
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [botones.botonReset])
//?Se realiza este useEffect con un estado de un boton de la categoria para que se active cuando el mismo cambie  y pueda en tiempo real cambiar los valores
    useEffect(() => {
        if(form.category==='ALL' && botones.botonCategoria===true && botones.botonReset===false){
          return  setbotones({...botones,botonReset:true})
        }
