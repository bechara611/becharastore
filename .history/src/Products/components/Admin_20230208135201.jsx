            ...
            <div className="row fila">
                <div className="col-10 col-md-5 contenedorGeneralMayor contenedor-productos animate__animated animate__zoomInRight">
                    <form className='formularioSubirProductos col-12'>
                        ...
                        <div className="row fondito centrarFilaFormulario ">
                            <div className="col-4">
                                <input id='txtidInterno' value={''} type="text" className='form-control ' placeholder='ID' onChange={(e) => {
                        ...
                        <div className="row fondito mt-2 centrarFilaFormulario ">
                            <div className="col-12">
                                <input id='txtshortdescription' value={''} type="text" className='form-control ' placeholder='Short description' onChange={(e) => {
                        ...
                        <div className="row fondito mt-2 centrarFilaFormulario">
                            <div className="col-12">
                                <select className="form-select col-12" aria-label="Select a category" value={''} onChange={(e) => {
                                    //aca estamos obteniendo el valor y guardandolo en el estado local
                        ...
                        <div className="row fondito mt-2 mb-2 centrarFilaFormulario">
                            <div className="col-12">
                                <textarea value={''} onChange={(e) => { }} className='form-control textarea' id='txtlongdescription' aria-describedby='emailHelp' placeholder='Message' />
                            </div>
                        </div>
