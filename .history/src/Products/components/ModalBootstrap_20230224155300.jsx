...
export const ModalBootstrap = ({ producto }) => {
    ...
    return (
        <div className="modal fade  " id={producto?.title} tabIndex={-1} aria-hidden="true" aria-labelledby="label-modal-1">
            <div className="modal-dialog modal-dialog-centered animate__animated animate__jackInTheBox">
