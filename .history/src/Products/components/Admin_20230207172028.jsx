    ...
    return (
        <>
            ...
            <div className="row fila ">
                <div className="col-md-12 col-10 contenedorGeneral contenedor-categorias animate__animated animate__zoomInLeft">
                    <form className='formularioAdminCategorias col-12'>
                        <div className="form-row centrarFilaFormulario">
                            <label htmlFor="txtcategoria">Create a new category</label>
                            <input id='txtcategoria' value={form.categoryEscrito} type="text" className='form-control col-6' placeholder='Category' onChange={(e) => {
