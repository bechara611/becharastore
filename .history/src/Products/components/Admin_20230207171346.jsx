        ...
        <>
            ...
            <div className="col-12 contenedor-articulos-home ">
                <div className="col-12 contenedor-articulos-home-titulo">
                    <h4 className='titulo-contacto  animate__animated animate__lightSpeedInLeft  '>Upload your categories</h4>
                </div>
            </div>
            ...
            <div className="row fila">
                <div className="col-11 col-md-12 p-5 ml-5 contenedorGeneralMayor animate__animated animate__zoomInUp">
