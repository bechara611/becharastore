    ...
    return (
        <>
            ...
            <div className="row fila ">
                <div className="col-md-4 col-12 contenedorGeneral contenedor-categorias animate__animated animate__zoomInLeft">
                ...
                <div className="col-12 p-5 m-5 col-md-4 contenedorGeneralMayor contenedor-productos animate__animated animate__zoomInRight">

                </div>
            </div>
            <div className="row fila">
                <div className="col-9 contenedorGeneralMayor animate__animated animate__zoomInUp">
