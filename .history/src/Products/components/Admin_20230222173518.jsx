                    ...
                    <form className='formularioSubirProductos col-12'>
                        ...
                        <div className="row  mt-2 centrarFilaFormulario ">
                            <div className="col-12">
                                <input id='txtshortdescription' value={form.productodescription} type="text" className='form-control ' alt='Only 70 length' maxLength={70} placeholder='Short description' onChange={(e) => {
