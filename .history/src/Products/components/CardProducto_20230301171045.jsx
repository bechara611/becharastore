...
export const CardProducto = ({ producto }) => {
    ...
    */}
            {producto?.urlimg &&
                <div  className="col-10  col-sm-4 col-md-4 cardProducto col-lg-2 m-1 mb-4 " id='cardProducto'>
                    <div className={`card ${producto.cantidad<=0 && 'opacitylow'} `} data-bs-toggle="modal" data-bs-target={`#a`+producto._id}>
