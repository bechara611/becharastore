...
export const Admin = () => {
    ...
    useEffect(() => {
        ...
        setform({ ...form, categorySeleccionada:( categorias[0] === 'ALL' ? categorias[1] : categorias[0]) || 'ddd' })
        setform({ ...form, productocategoria: (categorias[0] === 'ALL' ? categorias[1] : categorias[0])|| 'sss' })
        console.log({form})
        console.log({seleccion:form.categorySeleccionada})
        console.log({seleccion:categorias[1]})
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [categorias])
                    ...
                    <form className='formularioAdminCategorias'>
                        ...
                        <div className="form-row centrarFilaFormulario m-3">
                            <select className="form-select col-12" aria-label="Select a category" value={form.categorySeleccionada} onChange={(e) => {
                                ...
                                setform({
                                    ...form,
                                    categorySeleccionada: e.target.value.toUpperCase()ñ
                                })
