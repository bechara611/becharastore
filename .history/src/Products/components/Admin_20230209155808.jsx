...
export const Admin = () => {
    ...
    useEffect(() => {
        ...
        setform({ ...form, categorySeleccionada: categorias[0] === 'ALL' ? categorias[1] : categorias[0] || 'a' })
        setform({ ...form, productocategoria: categorias[0] === 'ALL' ? categorias[1] : categorias[0] || 'aa' })
