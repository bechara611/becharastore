    ...
    return (
        <>
            ...
            <div className="col-12  contenedor-titulo ">
                <div className="col-12  contenedor-titulo">
                    <h4 className='titulo animate__animated animate__lightSpeedInLeft  '>Upload your categories</h4>
                </div>
            </div>
            <div className="row fila ">
                <div className="col-md-4 col-10 contenedorGeneral contenedor-categorias animate__animated animate__zoomInLeft">
            ...
            <div className="col-12  contenedor-titulo ">
            <div className="col-12  contenedor-titulo">
                <h4 className='titulo animate__animated animate__lightSpeedInLeft  '>Upload your products</h4>
            </div>
        </div>
            <div className="row fila">
                <div className="col-10 col-md-6 contenedorGeneralMayor contenedor-productos animate__animated animate__zoomInRight">

                </div>
            </div>
            <div className="row fila">
                <div className="col-11 col-md-9 p-5 ml-5 contenedorGeneralMayor animate__animated animate__zoomInUp">
