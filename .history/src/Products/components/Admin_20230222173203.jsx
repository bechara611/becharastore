                    ...
                    <form className='formularioSubirProductos col-12'>
                        ...
                        <div className="row  mt-2 centrarFilaFormulario ">
                            <div className="col-12">
                                <input id='txtshortdescription' value={form.productodescription} type="text" className='form-control ' alt='Only 20 carachracters' maxLength={30} placeholder='Short description' onChange={(e) => {
