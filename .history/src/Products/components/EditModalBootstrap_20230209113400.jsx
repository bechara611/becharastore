...
export const EditModalBootstrap = ({ producto }) => {
    ...
    return (
        <div className="modal fondito fade  " id={producto?._id} tabIndex={-1} aria-hidden="true" aria-labelledby="label-modal-1">
                    ...
                    <div className="modal-body bg-light ">
                        <div className="col-12 ContenedorImagenModal">
                            <div className="col-10 col-lg-6  ContenedorImagenModal">
                             ...
                             {/*TODO  */}
                             <div className="contenedorGeneralMayor contenedor-productos animate__animated animate__zoomInRight">
