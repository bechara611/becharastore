    ...
    */}
            {producto?.urlimg &&
                <div className="col-12  col-sm-4 -4 col-lg-2 m-1 mb-4 animate__animated animate__jackInTheBox ">
                    <div className="card " data-bs-toggle="modal" data-bs-target="#modal1">
                        ...
                        <div className="card-body text-center">
                            ...
                            <button className=" btn btn-primary btn-sm  btn-lg"  data-bs-toggle="modal" data-bs-target="#modal1"
