...
export const Admin = () => {
    ...
    useEffect(() => {
        ...
        try {
            setcategoriaSave(categorias[0] === "ALL" ? categorias[1] : categorias[0])
    ...
    const onSaveProducto = () => {
              ...
              if (form.productoConformDataImg.length <= 0) {
                Swal.fire('Error', 'Please, you have to select an image', 'error')
                return
            }
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                handledSaveProductosUSE({
                  ...
                  //TODO si sale bien muestra el mensaje correcto
                  Swal.fire('SUCCESS', 'PROCESS COMPLETE', 'success')
                  //resetea los textos del formulario update
                  onResetLocal()
    ...
    const onDeleteCategorias =async () => {
        ...
        Swal.fire({
            ...
            /* Read more about isConfirmed, isDenied below */
            if (result.isConfirmed) {
                handledDeleteCategoriasUSE({ category: form.categorySeleccionada });
                    ...
                    <form className='formularioSubirProductos col-12'>
                        ...
                        <div className="row  mt-2 centrarFilaFormulario ">
                            <div className="col-12">
                                <input id='txtshortdescription' value={form.productodescription} type="text" className='form-control ' alt='Only 70 length' maxLength={60} placeholder='Short description' onChange={(e) => {
                        ...
                        <div className="row  mt-2 centrarFilaFormulario">
                            <div className="col-sm-8 col-12">
                                <select className="form-select col-12" aria-label="Please select a category" onChange={(e) => {
                                    //aca estamos obteniendo el valor y guardandolo en el estado local
                                    setform({ ...form, productocategoria: e.target.value })
                                    setcategoriaSave(e.target.value)
