    ...
    */}
            {producto?.urlimg &&
                <div  className="col-10  col-sm-4 col-md-4 cardProducto col-lg-2 m-1 mb-4 animate__animated animate__jackInTheBox " id='cardProducto'>
                    <div className={`card ${producto.cantidad<=0 && 'opacitylow'} `} data-bs-toggle="modal" data-bs-target={`#`+producto._id}>
                   {producto.cantidad<=0 && <div className={` ${producto.cantidad<=0 && 'opacityUP'} textoCard`}>NO DISPONIBLE</div>
