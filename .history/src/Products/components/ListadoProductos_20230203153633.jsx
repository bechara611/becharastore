...
export const ListadoProductos = () => {
    ...
    const [botones,setbotones]=useState({botonCategoria:false,botonReset:false,botonSearch:true})
    ...
    const onHandledSubmit = (e) => {
        ...
        setbotones({...botones,botonReset:false})
    }
    const onCargarmas = () => {
            ...
            <div className="row ">
                ...
                <i className="fa-solid fa-arrows-rotate m-2 iconoReset" onClick={()=>{
                    ...
                    <div className="col-md-2 col-6 m-1">
                        ...
                        <select className="form-select col-12" aria-label="Select a category" value={form.category} defaultValue={'ALL'} onChange={(e) => {
                            //aca estamos obteniendo el valor y guardandolo en el estado local
                            setform({
                                ...form,
