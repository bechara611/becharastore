            ...
            <div className="col-12  col-sm-4 -4 col-lg-2 m-1 mb-4 ">
                <div className="card">
                    ...
                    <div className="card-body text-center">
                        ...
                        <div className="contenedor-texto-card"><p className="card-text">{'The best product lorem10The best productThe best productThe best productThe best product'}</p></div>
