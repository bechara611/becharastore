...
export const ListadoProductos = () => {
    const {handledAsignar5productosMasUSE,handledGetProductosUSE} = useProductos();
    ...
    const onCargarmas=()=>{
       ...
       console.log(productoscargando5.length)
        
        handledAsignar5productosMasUSE((productoscargando5.length),valor5)
    }
    useEffect(() => {
