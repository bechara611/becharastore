            ...
            <div className="row mt-2 mb-5">
                <div className="col-12 contenedor-productos-padre fondito">
                    <div className="col-10 contenedor-productos-hijo">
                        <div className="col-2 contenedor-producto-hijoJr fondito2 m-1"></div>
                        <div className="col-2 contenedor-producto-hijoJr fondito2 m-1"></div>
                        <div className="col-2 contenedor-producto-hijoJr fondito2 m-1"></div>
                        <div className="col-2 contenedor-producto-hijoJr fondito2 m-1"></div>
                        <div className="col-2 contenedor-producto-hijoJr fondito2 m-1"></div>
                    ...
                    <div className="col-12 contenedor-vermas"><button className='btn btn-primary'>Ver mas</button></div>
                </div>
