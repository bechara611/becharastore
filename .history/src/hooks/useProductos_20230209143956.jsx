...
import { DeleteCategorias, DeleteProductos, GetCategorias, GetProductos, PostsaveCategorias, PostsaveProductos } from "../Products/API/Productos"
...
export const useProductos = () => {
    ...
    const handledSaveProductosUSE = async (producto) => {
        ...
        //metodo para guardar un producto
        const handledUpdateProductosUSE = async (producto) => {
            //TODO conexion con el backend para actualizar producto
            console.log(producto)
